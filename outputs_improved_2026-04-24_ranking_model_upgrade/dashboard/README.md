...
This folder contains the published static dashboard for `outputs_improved_2026-04-24_ranking_model_upgrade`.
...
```powershell
cd .\outputs_improved_2026-04-24_ranking_model_upgrade\dashboard
...
That rebuilds `dashboard/dashboard_data.js` and updates `outputs_improved_2026-04-24_ranking_model_upgrade/RANKING_DASHBOARD_TECHNICAL_NOTE.md`.
