...
- `Takeda Shingen`: Performs very strongly in battle-dominant models, but the rank drops when higher-level war/campaign pages are allowed to dilute battle-only performance. Rank signature `B0=4, B1=4, H=76, HF=75, HE=63, HB=83`.
...
- `Francis Vere`: Performs very strongly in battle-dominant models, but the rank drops when higher-level war/campaign pages are allowed to dilute battle-only performance. Rank signature `B0=11, B1=18, H=74, HF=85, HE=61, HB=84`.
...
- `Robert L. Eichelberger`: Performs very strongly in battle-dominant models, but the rank drops when higher-level war/campaign pages are allowed to dilute battle-only performance. Rank signature `B0=15, B1=25, H=116, HF=119, HE=183, HB=74`.
...
- `Nelson A. Miles`: Higher-level war/campaign/operation pages are doing substantial work. Battle-only restrictions cause a severe collapse. Rank signature `B0=NA, B1=920, H=77, HF=74, HE=10, HB=88`.
...
- `Stepa Stepanović`: Higher-level war/campaign/operation pages are doing substantial work. The commander is not competitive in the strict baseline cohort. Rank signature `B0=191, B1=103, H=15, HF=16, HE=22, HB=37`.
...
- `Bernard Montgomery`: Higher-level war/campaign/operation pages are doing substantial work. Rank signature `B0=99, B1=68, H=37, HF=35, HE=35, HB=23`.

The sharpest caution signals in this snapshot are `Flavius Aetius`, `Petar Bojović`, `Nelson A. Miles`, `Emperor Taizong of Tang`, `Stepa Stepanović`, `Dwight D. Eisenhower`, `Živojin Mišić`, and `Bernard Montgomery`. These outcomes may still reflect real historical prominence, but the current package does not support treating them as robust all-time elite placements.
...
- `Takeda Shingen`: best `4`, worst `83`, range `79`. The placement is too model-dependent to treat as a strong all-model conclusion. Rank signature `B0=4, B1=4, H=76, HF=75, HE=63, HB=83`.
...
- `Nelson A. Miles`: best `10`, worst `920`, range `910`. Higher-level war/campaign/operation pages are doing substantial work. Battle-only restrictions cause a severe collapse. Rank signature `B0=NA, B1=920, H=77, HF=74, HE=10, HB=88`.
- `Francis Vere`: best `11`, worst `84`, range `73`. The placement is too model-dependent to treat as a strong all-model conclusion. Rank signature `B0=11, B1=18, H=74, HF=85, HE=61, HB=84`.
...
- `Stilicho` (tentative_signal): Useful as an audit case for the era, not as a secure top-tier conclusion; rank signature B0=117, B1=93, H=96, HF=105, HE=53, HB=105. The era signal is thin; treat this as a weak provisional inclusion.
- `Julian` (tentative_signal): Useful as an audit case for the era, not as a secure top-tier conclusion; rank signature B0=48, B1=99, H=168, HF=227, HE=162, HB=184. The era signal is thin; treat this as a weak provisional inclusion.
- `Constantine the Great` (tentative_signal): Useful as an audit case for the era, not as a secure top-tier conclusion; rank signature B0=108, B1=72, H=338, HF=333, HE=266, HB=362. The era signal is thin; treat this as a weak provisional inclusion.
...
- `Takeda Shingen` (strong_but_model_sensitive): Belongs in the era shortlist, but the case depends on model choice; rank signature B0=4, B1=4, H=76, HF=75, HE=63, HB=83. Performs very strongly in battle-dominant models, but the rank drops when higher-level war/campaign pages are allowed to dilute battle-only performance.
...
- `Sarath Fonseka` (tentative_signal): Useful as an audit case for the era, not as a secure top-tier conclusion; rank signature B0=92, B1=66, H=231, HF=220, HE=255, HB=244. The era signal is thin; treat this as a weak provisional inclusion.
