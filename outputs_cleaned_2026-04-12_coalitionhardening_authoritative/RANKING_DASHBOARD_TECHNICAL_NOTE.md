...
This dashboard is wired directly to the authoritative snapshot in `outputs_cleaned_2026-04-12_coalitionhardening_authoritative`.
...
Current commander universe in the dashboard: `2481`
