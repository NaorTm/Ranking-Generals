...
This folder contains the published static dashboard for `outputs_improved_2026-04-24_upgrade_pass3_confidence`.
...
```powershell
cd .\outputs_improved_2026-04-24_upgrade_pass3_confidence\dashboard
...
That rebuilds `dashboard/dashboard_data.js` and updates `outputs_improved_2026-04-24_upgrade_pass3_confidence/RANKING_DASHBOARD_TECHNICAL_NOTE.md`.
